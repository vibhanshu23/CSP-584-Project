	...
	protected void doGet(HttpServletRequest request,
		...
		else if (action.equals("UpdateBusRoute"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					// + "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Console</option><option value='games'>Games</option><option value='tablets'>Tablet</option><option value='accessories'>Accessory</option></select>"
					// + "</td></tr><tr><td>"
					+ "<h3>Route Number</h3></td><td><input type='text' name='productId' value='' class='input' ></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Route Name</h3></td><td><input type='text' name='productName' value='' class='input' ></input>"
					+ "</td></tr><tr><td>"
		...
		else if (action.equals("UpdateBusStop"))
		{
		     pw.print("<div id='content'><div class='post'>");
				...
				+ "<h3>Route Name</h3></td><td><input type='text' name='productName' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Bus Route Direction</h3></td><td><input type='text' name='busRouteDirection' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Stop Id</h3></td><td><input type='text' name='stopId' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Stop Name</h3></td><td><input type='text' name='stopName' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Stop Latitute</h3></td><td><input type='text' name='stoplat' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>Stop Logitute</h3></td><td><input type='text' name='stoplon' value='' class='input' ></input>"
				+ "</td></tr><tr><td>"
